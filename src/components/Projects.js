            ...
            <div>
                ...
                <div class="column">
                        <div class="card">
                            ...
                            <a href = "https://github.com/ghaxhaj/NBARef" className = "cardText">Front-End Repository</a><br></br>
                            <a href = "https://github.com/ghaxhaj/NBARefBackEnd" className = "cardText">Back-End Repository</a><br></br>
                            <a href = "https://vimeo.com/421127797" className = "cardText">Demo</a>
                        </div>
                    </div>
                    <div class="column">
                        <div class="card">
                            ...
                            <a href = "https://github.com/ghaxhaj/flat-gram" className = "cardText">Front-End Repository</a><br></br>
                            <a href = "https://github.com/sekoudosso82/flat-gram-back-end" className = "cardText">Back-End Repository</a><br></br>
                            <a href = "https://vimeo.com/421127166" className = "cardText">Demo</a>
                        </div>
                    </div>
                    <div class="column">
                        <div class="card">
                            ...
                            <a href = "https://github.com/ftodoroski/aMazeing/tree/Granit" className = "cardText">Front-End Repository</a><br></br>
                            <a href = "https://vimeo.com/421125815" className = "cardText">Demo</a>
                            <h1></h1>
                        </div>
                    </div>
                    <div class="column">
                        <div class="card">
                            ...
                            <a href = "https://github.com/ghaxhaj/SoundLoud" className = "cardText">Repository</a>
                            <h1></h1>
                        </div>
                    </div>
                    </div>
